...
(function(e) {
    ...
    t.o = function() {
        ...
        this.run = function() {
            ...
            if (this.$.is("fieldset")) {
                ...
                this.$.bind("change blur", function() { n.val(n._validate(n.o.parse(n.$.val()))) })
            ...
            if (!this.c) { throw { name: "CanvasNotSupportedException", message: "Canvas not supported. Please use excanvas on IE8.0.", toString: function() { return this.name + ": " + this.message } } }
    ...
    t.Dial = function() {
        ...
        this.xy2val = function(e, t) {
            ...
            if (this.angleArc != this.PI2 && i < 0 && i > -.5) { i = 0 } else if (i < 0) { i += this.PI2 }
        ...
        this.listen = function() {
            ...
            this.$.bind("keydown", function(i) {
                var s = i.keyCode;
                if (s >= 96 && s <= 105) { s = i.keyCode = s - 48 }
                ...
                if (isNaN(u)) {
                    ...
                    if (e.inArray(s, [37, 38, 39, 40]) > -1) {
                        ...
                        t._draw();
                        a = window.setTimeout(function() { f *= 2 }, 30)
                    }
                }
